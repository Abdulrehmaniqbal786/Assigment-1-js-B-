const MyUniqueArray = [
    ...
    const MyUniqueCards = document.getElementById("NoSameId");
    for (let i = 0; i < MyUniqueArray.length ;i++){
        ...
        image_url:uniqueidimg} = MyUniqueArray[i]


           MyUniqueCards .innerHTML += `<div class="card" style="width: 18rem;">
            <img src="${uniqueidimg}" class="card-img-top" alt="...">
            <div class="card-body">
              <h5  class="card-title">${uniquetitle}</h5>
              <p class="card-text">${uniquedescription}</p>
              ${uniqueprice}
              <br>
              <br> 
